    ...
    <>
      <header className='header-top-strip py-3'>
        <div className='container-xxl'>
          <div className='row'>
            <div className='col-6'>
              <p className='text-white mb-0'>Envios gratis superando los U$S 100</p>
            </div>
            <div className='col-6'>
              <p className='text-end text-white mb-0'>
                Telefono de Contacto: <a className='text-white' href='0800-912-2018'> 0800-912-2018 </a>
              </p>
            </div>
          </div>
        </div>
      ...
      <header className='header-upper py-3'>
        <div className='container-xxl'>
          <div className='row align-items-center'>
            <div className='col-2'>
              <h1>
                <Link className='text-white'>Digitex</Link>
              </h1>
            </div>
            <div className='col-5'>
